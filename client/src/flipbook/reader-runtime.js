...
if(mobile){
  ...
  var under=document.createElement('div');under.className='mobile-under';layer.appendChild(under);
...
if(forward)underLeft.appendChild(copy(old));else underRight.appendChild(copy(old));
